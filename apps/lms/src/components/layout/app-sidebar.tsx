...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      variant="sidebar"
      collapsible="none"
      className="border-border/40 border-r pl-2"
    >
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton
                  size="lg"
                  className="hover:bg-sidebar-accent justify-start rounded-lg px-2 py-5"
                >
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem className="mb-4">
                <SidebarMenuButton className="bg-background border-border/50 text-foreground hover:bg-background/90 h-10 w-full gap-2 rounded-[8px] border px-3 font-medium shadow-sm">
